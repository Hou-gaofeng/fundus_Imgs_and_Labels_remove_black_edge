...
def main(img_label_dir, save_dir, thickness=2):
    ...
    for name in image_list:
        ...
        label_EX_file = label_dir_EX + '/' + name + '.tif'
        label_HE_file = label_dir_HE + '/' + name + '.tif'
        label_MA_file = label_dir_MA + '/' + name + '.tif'
        label_SE_file = label_dir_SE + '/' + name + '.tif'
...
if __name__ == '__main__':
    img_label_dir = './DDR_segmentation/Segmentation/valid'
    save_dir = './DDR_segmentation/Segmentation/img_label_visualization/valid'
